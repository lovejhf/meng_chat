...
import com.mengchat.chat.kit.IMServiceStatusViewModel;
import com.mengchat.chat.kit.WfcBaseActivity;
import com.mengchat.chat.kit.WfcUIKit;
import com.mengchat.chat.kit.channel.ChannelViewModel;
import com.mengchat.chat.kit.chatroom.ChatRoomViewModel;
import com.mengchat.chat.kit.common.OperateResult;
import com.mengchat.chat.kit.conversation.ext.core.ConversationExtension;
...
import com.mengchat.chat.kit.group.GroupViewModel;
...
import com.mengchat.chat.kit.widget.InputAwareLayout;
import com.mengchat.chat.kit.widget.KeyboardAwareLinearLayout;
...
//    }
    ...
    private void setTitle() {
        ...
        } else if (conversation.type == Conversation.ConversationType.Group) {//群聊
            if (groupInfo != null) {
                conversationTitle = groupInfo.name;//显示群聊的名称
            }
    ...
    private void updateTypingStatusTitle(TypingMessageContent typingMessageContent) {
        ...
        switch (typingMessageContent.getType()) {
            ...
            case TypingMessageContent.TYPING_FILE:
                typingDesc = "对方正在发送文件";
                break;
            case TypingMessageContent.TYPING_RED:
                typingDesc = "";//对方正在发送红包
                break;
