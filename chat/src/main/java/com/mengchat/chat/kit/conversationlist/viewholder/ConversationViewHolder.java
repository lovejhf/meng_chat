...
import com.mengchat.chat.kit.annotation.ConversationContextMenuItem;
import com.mengchat.chat.kit.conversation.ConversationActivity;
import com.mengchat.chat.kit.conversation.Draft;
...
import com.mengchat.chat.kit.third.utils.TimeUtils;
...
public abstract class ConversationViewHolder extends RecyclerView.ViewHolder {
    ...
    protected CircleImageView portraitImageView;
    @Bind(R.id.slient)
